...
/* package typelayer-filesystem-collection-0.0.0 */
#ifndef VERSION_typelayer_filesystem_collection
#define VERSION_typelayer_filesystem_collection "0.0.0"
#endif /* VERSION_typelayer_filesystem_collection */
#ifndef MIN_VERSION_typelayer_filesystem_collection
#define MIN_VERSION_typelayer_filesystem_collection(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  0 || \
  (major1) == 0 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_typelayer_filesystem_collection */
...
#define CURRENT_PACKAGE_KEY "typelayer-filesystem-collection-0.0.0-10fceq4BeA05hTSImC1quz"
#endif /* CURRENT_PACKAGE_KEY */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "typelayer-filesystem-collection-0.0.0-10fceq4BeA05hTSImC1quz"
