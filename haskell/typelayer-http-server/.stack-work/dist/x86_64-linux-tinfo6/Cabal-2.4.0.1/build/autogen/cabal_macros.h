...
/* package typelayer-http-server-0.0.0 */
#ifndef VERSION_typelayer_http_server
#define VERSION_typelayer_http_server "0.0.0"
#endif /* VERSION_typelayer_http_server */
#ifndef MIN_VERSION_typelayer_http_server
#define MIN_VERSION_typelayer_http_server(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  0 || \
  (major1) == 0 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_typelayer_http_server */
...
#define CURRENT_PACKAGE_KEY "typelayer-http-server-0.0.0-Eb71IIE2EvbG2TSfI5U4jl"
#endif /* CURRENT_PACKAGE_KEY */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "typelayer-http-server-0.0.0-Eb71IIE2EvbG2TSfI5U4jl"
