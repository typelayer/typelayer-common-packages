...
/* package typelayer-c-backend-0.0.0 */
#ifndef VERSION_typelayer_c_backend
#define VERSION_typelayer_c_backend "0.0.0"
#endif /* VERSION_typelayer_c_backend */
#ifndef MIN_VERSION_typelayer_c_backend
#define MIN_VERSION_typelayer_c_backend(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  0 || \
  (major1) == 0 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_typelayer_c_backend */
...
#define CURRENT_PACKAGE_KEY "typelayer-c-backend-0.0.0-92VvVVQfcgA8OkuqptcAqW"
#endif /* CURRENT_PACKAGE_KEY */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "typelayer-c-backend-0.0.0-92VvVVQfcgA8OkuqptcAqW"
