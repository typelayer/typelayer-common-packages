...
mocha.describe("myFirstModuleEncodableSymmetry", () => {
    mocha.it("myEnumIntegerMyTextField0Json", () => {
        ...
        let myTextFieldFieldTestVal : number;
        let resultingBin : Uint8Array;
        let val : myFirstPackageSchemasMyFirstModuleStructures.MyEnumStructure;
        let valToCheck : myFirstPackageSchemasMyFirstModuleStructures.MyEnumStructure;
        encoding = new typelayerCommonEncodingsJson.JsonEncoding({});
        myTextFieldFieldTestVal = 0;
        val = new myFirstPackageSchemasMyFirstModuleStructures.MyEnumInteger({myTextField: myTextFieldFieldTestVal});
    ...
    mocha.it("myFirstStructureMyBooleanField0Json", () => {
        ...
        let encoder : typelayerCommonDynamic.Encoder;
        let encoding : typelayerCommonDynamic.Encoding;
        let myBooleanFieldFieldTestVal : boolean;
        let myDoubleFieldDefault : number;
        let myIntegerFieldDefault : number;
        let myListFieldDefault : Array<string>;
        let myMapFieldDefault : Map<string, string>;
        let myNestedFieldDefault : myFirstPackageSchemasMyFirstModuleStructures.MyEnumStructure;
        let myTextFieldDefault : string;
        let resultingBin : Uint8Array;
        let val : myFirstPackageSchemasMyFirstModuleStructures.MyFirstStructure;
        let valToCheck : myFirstPackageSchemasMyFirstModuleStructures.MyFirstStructure;
        encoding = new typelayerCommonEncodingsJson.JsonEncoding({});
        ...
        myTextFieldDefault = "";
        val = new myFirstPackageSchemasMyFirstModuleStructures.MyFirstStructure({myBooleanField: myBooleanFieldFieldTestVal, myDoubleField: myDoubleFieldDefault, myIntegerField: myIntegerFieldDefault, myListField: myListFieldDefault, myMapField: myMapFieldDefault, myNestedField: myNestedFieldDefault, myTextField: myTextFieldDefault});
        encoder = encoding.encodingStartEncoding();
    ...
    mocha.it("myFirstStructureMyDoubleField0Json", () => {
        ...
        let encoder : typelayerCommonDynamic.Encoder;
        let encoding : typelayerCommonDynamic.Encoding;
        let myBooleanFieldDefault : boolean;
        let myDoubleFieldFieldTestVal : number;
        let myIntegerFieldDefault : number;
        let myListFieldDefault : Array<string>;
        let myMapFieldDefault : Map<string, string>;
        let myNestedFieldDefault : myFirstPackageSchemasMyFirstModuleStructures.MyEnumStructure;
        ...
        myNestedFieldDefault = myFirstPackageSchemasMyFirstModuleStructures.defaultMyEnumStructure();
        myTextFieldDefault = "";
        val = new myFirstPackageSchemasMyFirstModuleStructures.MyFirstStructure({myDoubleField: myDoubleFieldFieldTestVal, myBooleanField: myBooleanFieldDefault, myIntegerField: myIntegerFieldDefault, myListField: myListFieldDefault, myMapField: myMapFieldDefault, myNestedField: myNestedFieldDefault, myTextField: myTextFieldDefault});
        encoder = encoding.encodingStartEncoding();
        myFirstPackageSchemasMyFirstModuleDynamic.dynamicPutMyFirstStructure(encoder, val);
        resultingBin = encoder.encoderToBinary();
        decoder = encoding.encodingStartDecoding(resultingBin);
    ...
    mocha.it("myFirstStructureMyIntegerField0Json", () => {
        ...
        let myBooleanFieldDefault : boolean;
        let myDoubleFieldDefault : number;
        let myIntegerFieldFieldTestVal : number;
        let myListFieldDefault : Array<string>;
        let myMapFieldDefault : Map<string, string>;
        let myNestedFieldDefault : myFirstPackageSchemasMyFirstModuleStructures.MyEnumStructure;
        let myTextFieldDefault : string;
        ...
        myNestedFieldDefault = myFirstPackageSchemasMyFirstModuleStructures.defaultMyEnumStructure();
        myTextFieldDefault = "";
        val = new myFirstPackageSchemasMyFirstModuleStructures.MyFirstStructure({myIntegerField: myIntegerFieldFieldTestVal, myDoubleField: myDoubleFieldDefault, myBooleanField: myBooleanFieldDefault, myListField: myListFieldDefault, myMapField: myMapFieldDefault, myNestedField: myNestedFieldDefault, myTextField: myTextFieldDefault});
        encoder = encoding.encodingStartEncoding();
        myFirstPackageSchemasMyFirstModuleDynamic.dynamicPutMyFirstStructure(encoder, val);
        resultingBin = encoder.encoderToBinary();
        decoder = encoding.encodingStartDecoding(resultingBin);
    ...
    mocha.it("myFirstStructureMyListField0Json", () => {
        ...
        let myDoubleFieldDefault : number;
        let myIntegerFieldDefault : number;
        let myListFieldFieldTestVal : Array<string>;
        let myMapFieldDefault : Map<string, string>;
        let myNestedFieldDefault : myFirstPackageSchemasMyFirstModuleStructures.MyEnumStructure;
        let myTextFieldDefault : string;
        let resultingBin : Uint8Array;
        ...
        myNestedFieldDefault = myFirstPackageSchemasMyFirstModuleStructures.defaultMyEnumStructure();
        myTextFieldDefault = "";
        val = new myFirstPackageSchemasMyFirstModuleStructures.MyFirstStructure({myListField: myListFieldFieldTestVal, myIntegerField: myIntegerFieldDefault, myDoubleField: myDoubleFieldDefault, myBooleanField: myBooleanFieldDefault, myMapField: myMapFieldDefault, myNestedField: myNestedFieldDefault, myTextField: myTextFieldDefault});
        encoder = encoding.encodingStartEncoding();
        myFirstPackageSchemasMyFirstModuleDynamic.dynamicPutMyFirstStructure(encoder, val);
        resultingBin = encoder.encoderToBinary();
        decoder = encoding.encodingStartDecoding(resultingBin);
    ...
    mocha.it("myFirstStructureMyMapField0Json", () => {
        ...
        let myIntegerFieldDefault : number;
        let myListFieldDefault : Array<string>;
        let myMapFieldFieldTestVal : Map<string, string>;
        let myNestedFieldDefault : myFirstPackageSchemasMyFirstModuleStructures.MyEnumStructure;
        let myTextFieldDefault : string;
        let resultingBin : Uint8Array;
        let val : myFirstPackageSchemasMyFirstModuleStructures.MyFirstStructure;
        ...
        myNestedFieldDefault = myFirstPackageSchemasMyFirstModuleStructures.defaultMyEnumStructure();
        myTextFieldDefault = "";
        val = new myFirstPackageSchemasMyFirstModuleStructures.MyFirstStructure({myMapField: myMapFieldFieldTestVal, myListField: myListFieldDefault, myIntegerField: myIntegerFieldDefault, myDoubleField: myDoubleFieldDefault, myBooleanField: myBooleanFieldDefault, myNestedField: myNestedFieldDefault, myTextField: myTextFieldDefault});
        encoder = encoding.encodingStartEncoding();
        myFirstPackageSchemasMyFirstModuleDynamic.dynamicPutMyFirstStructure(encoder, val);
        resultingBin = encoder.encoderToBinary();
        decoder = encoding.encodingStartDecoding(resultingBin);
    ...
    mocha.it("myFirstStructureMyMapField2Json", () => {
        ...
        encoding = new typelayerCommonEncodingsJson.JsonEncoding({});
        myMapFieldBlocks = "";
        myMapFieldFieldTestVal = new Map([["key-1", myMapFieldBlocks], ["key-2-1", myMapFieldBlocks]]);
        myListFieldDefault = [];
        myIntegerFieldDefault = 0;
        myDoubleFieldDefault = 0.0;
        myBooleanFieldDefault = false;
    ...
    mocha.it("myFirstStructureMyNestedField0Json", () => {
        ...
        let myListFieldDefault : Array<string>;
        let myMapFieldDefault : Map<string, string>;
        let myNestedFieldFieldTestVal : myFirstPackageSchemasMyFirstModuleStructures.MyEnumStructure;
        let myTextFieldDefault : string;
        let resultingBin : Uint8Array;
        let val : myFirstPackageSchemasMyFirstModuleStructures.MyFirstStructure;
        let valToCheck : myFirstPackageSchemasMyFirstModuleStructures.MyFirstStructure;
        ...
        myBooleanFieldDefault = false;
        myTextFieldDefault = "";
        val = new myFirstPackageSchemasMyFirstModuleStructures.MyFirstStructure({myNestedField: myNestedFieldFieldTestVal, myMapField: myMapFieldDefault, myListField: myListFieldDefault, myIntegerField: myIntegerFieldDefault, myDoubleField: myDoubleFieldDefault, myBooleanField: myBooleanFieldDefault, myTextField: myTextFieldDefault});
        encoder = encoding.encodingStartEncoding();
        myFirstPackageSchemasMyFirstModuleDynamic.dynamicPutMyFirstStructure(encoder, val);
        resultingBin = encoder.encoderToBinary();
        decoder = encoding.encodingStartDecoding(resultingBin);
    ...
    mocha.it("myFirstStructureMyTextField0Json", () => {
        ...
        let myMapFieldDefault : Map<string, string>;
        let myNestedFieldDefault : myFirstPackageSchemasMyFirstModuleStructures.MyEnumStructure;
        let myTextFieldFieldTestVal : string;
        let resultingBin : Uint8Array;
        let val : myFirstPackageSchemasMyFirstModuleStructures.MyFirstStructure;
        let valToCheck : myFirstPackageSchemasMyFirstModuleStructures.MyFirstStructure;
        encoding = new typelayerCommonEncodingsJson.JsonEncoding({});
        ...
        myDoubleFieldDefault = 0.0;
        myBooleanFieldDefault = false;
        val = new myFirstPackageSchemasMyFirstModuleStructures.MyFirstStructure({myTextField: myTextFieldFieldTestVal, myNestedField: myNestedFieldDefault, myMapField: myMapFieldDefault, myListField: myListFieldDefault, myIntegerField: myIntegerFieldDefault, myDoubleField: myDoubleFieldDefault, myBooleanField: myBooleanFieldDefault});
        encoder = encoding.encodingStartEncoding();
        myFirstPackageSchemasMyFirstModuleDynamic.dynamicPutMyFirstStructure(encoder, val);
        resultingBin = encoder.encoderToBinary();
        decoder = encoding.encodingStartDecoding(resultingBin);
